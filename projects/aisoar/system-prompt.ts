...
2. **A unit blocked with a testModeDecisionRequired field** (in its result) is NOT a real approval gate — it's this one destructive step waiting on the user's choice. Ask plainly: "execute for real" or "simulate"? Never guess or default to one. Once they answer, call resolve_test_run_destructive_step with that unitId/stepId/decision — this both records the choice and resumes the run.
